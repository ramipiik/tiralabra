...
def run_heuristics(tictactoe:TicTacToe):        
    ...
    x_closeness_bonus=closeness_check.closeness_check(tictactoe,'X')*tictactoe.closeness_weight
    o_closeness_bonus=closeness_check.closeness_check(tictactoe,'O')*tictactoe.closeness_weight
    ...
    if tictactoe.count_empty()==tictactoe.board_size**2-2:
        x_closeness_bonus=closeness_check.closeness_check(tictactoe, 'X', True)*tictactoe.closeness_weight

    #scores the position based on distance from the center. Closer to centre is better. Small impact.
    x_center_bonus=boundaries_check.boundaries_check(tictactoe, 'X')*tictactoe.center_weight
    o_center_bonus=boundaries_check.boundaries_check(tictactoe, 'O')*tictactoe.center_weight
